...
API 网关api-gateway是无人机路径规划系统的统一入口基?Spring Cloud Gateway 实现路由转发负载均衡限流熔断和安全过滤?
...
| 路由 | 目标服务 | 端口 | 熔断?| 说明 |
|------|---------|:----:|:------:|------|
| `/api/v1/**` | uav-platform-service | 8080 | ✅ | 主平台服?|
...
所有路由均通过 `common-utils` 模块?Resilience4j 熔断器保护
...
- **重试**: Retry (3? BAD_GATEWAY/SERVICE_UNAVAILABLE)
- **负载均衡**: Nacos lb:// 服务发现
- **熔断?*: Resilience4j Circuit Breaker (通过 common-utils)
