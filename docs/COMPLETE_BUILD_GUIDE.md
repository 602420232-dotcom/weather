...
- [第一章：环境搭建 —— 把工具都装好](#_3)
  - [1.1 开发环境选型标准与版本适配](#11)
  - [1.2 JDK 17 安装与配置](#12-jdk-17)
  - [1.3 Maven 安装配置与镜像源设置](#13-maven)
  - [1.4 Node.js 与 npm 安装配置](#14-nodejs-npm)
  - [1.5 Docker 与 Docker Compose 安装](#15-docker-docker-compose)
  - [1.6 Flutter SDK 安装与配置](#16-flutter-sdk)
  - [1.7 Python 环境配置](#17-python)
  - [1.8 IDE 开发工具安装与配置](#18-ide)
  - [1.9 Git 安装与配置](#19-git)
  - [1.10 中间件安装（MySQL / Redis / Nacos / Kafka）](#110-mysql-redis-nacos-kafka)
- [第二章：源码获取 —— 把代码拿下来](#_18)
  - [2.1 项目拉取](#21)
  - [2.2 项目目录结构详解](#22)
  - [2.3 各模块职责说明](#23)
- [第三章：模块开发 —— 开始写代码](#_27)
  - [3.1 Java 17 必备基础知识点](#31-java-17)
  - [3.2 SpringBoot 微服务核心架构原理](#32-springboot)
  - [3.3 Maven 依赖管理与多模块配置详解](#33-maven)
  - [3.4 后端微服务模块开发实战](#34)
  - [3.5 数据库设计与连接配置](#35)
  - [3.6 Nacos 服务注册与配置中心接入](#36-nacos)
  - [3.7 Redis 缓存与 Kafka 消息队列使用](#37-redis-kafka)
  - [3.8 Vue 前端项目开发指南](#38-vue)
  - [3.9 Flutter 移动端开发指南](#39-flutter)
- [第四章：联调测试 —— 让所有部分一起工作](#_28)
  - [4.1 后端微服务本地联调](#41)
  - [4.2 前后端接口联调](#42)
  - [4.3 Flutter 客户端联调](#43-flutter)
  - [4.4 功能测试思路与测试用例设计](#44)
  - [4.5 接口测试执行方案](#45)
- [第五章：容器部署 —— 打包发布上线](#_29)
  - [5.1 Docker 镜像构建与多阶段打包](#51-docker)
  - [5.2 Docker Compose 服务编排](#52-docker-compose)
  - [5.3 一键部署完整流程](#53)
  - [5.4 生产环境服务器准备与域名配置](#54)
- [第六章：运维排障 —— 出了问题怎么办](#_30)
  - [6.1 日常维护清单](#61)
  - [6.2 常见报错原因分析与解决方案](#62)
- [附录：专题文档索引](#_35)
...
> Flutter 环境详细配置请参阅：[uav-mobile-app 文档](external/uav-mobile-app.md)
...
| 主题 | 说明 | 在本文档中的位置 |
|------|------|-----------------|
| **Java 17 基础** | 类与对象、注解、数据结构速成 | [3.1 节](#31-java-17) |
| **SpringBoot 微服务** | 分层架构、配置、启动流程 | [3.2 节](#32-springboot) |
| **Maven 多模块** | 父 POM、聚合构建、常用命令 | [3.3 节](#33-maven) |
| **后端开发实战** | 微服务启动、数据库配置、Nacos 接入 | [3.4~3.7 节](#34) |
| **Vue 前端开发** | 项目结构、组件、接口调用、代理配置 | [3.8 节](#38-vue) |
| **Flutter 移动端** | 环境搭建、编译、调试、打包 | [3.9 节](#39-flutter) |
| **联调测试** | 微服务联调、前后端联调、接口测试 | [第四章](#_28) |
| **Docker 容器化** | 多阶段构建、Compose 编排、一键部署 | [第五章](#_29) |
| **运维排障** | 日常维护、常见问题、应急操作 | [第六章](#_30) |
