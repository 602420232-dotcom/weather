...
适用于生产环境，详细步骤请参考[部署指南](deployment/DEPLOYMENT.md)：
...
详细配置请参考[熔断器指南](guides/CIRCUIT_BREAKER_GUIDE.md)。
...
- [API总览](api/README.md)
- [用户认证API](api/uav-platform-service/auth.md)
- [无人机管理API](api/uav-platform-service/drone.md)
- [任务管理API](api/uav-platform-service/task.md)
- [路径规划API](api/path-planning-service/path.md)
- [气象数据API](api/meteor-forecast-service/forecast.md)
- [WRF处理API](api/wrf-processor-service/wrf.md)
- [数据同化API](api/data-assimilation-service/assimilation.md)
...
详细项目结构请参考[项目结构指南](PROJECT_STRUCTURE.md)。
...
- [Kubernetes部署指南](deployment/DEPLOYMENT.md)
- [生产环境部署清单](deployment/DEPLOY_GUIDE.md)
...
2. 查看 [项目质量审计报告](reports/COMPREHENSIVE_QUALITY_ASSESSMENT.md)
3. 提交 Issue 到 GitHub
...
查看 [更新日志](UPGRADE_REPORT.md) 了解项目进展。
