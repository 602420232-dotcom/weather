...
本文档提供了无人机路径规划系统的 API 接口说明包括各个微服务的接口定义参数说明和使用示例?

## 服务列表

| 服务 | 端口 | 说明 |
|------|------|------|
| **api-gateway** | 8088 | API 网关统一入口 |
| **uav-platform-service** | 8080 | 主服务提供系统的核心功?|
| **wrf-processor-service** | 8081 | WRF 气象数据处理服务 |
| **meteor-forecast-service** | 8082 | 气象预测服务 |
| **path-planning-service** | 8083 | 路径规划服务 |
| **data-assimilation-service** | 8084 | 贝叶斯同化服?|
| **uav-weather-collector** | 8086 | 气象信息收集服务 |
| **edge-cloud-coordinator** | 8000 | 边云协同框架联邦学?WebSocket?|

## 认证与授?

所?API 接口都需要使?JWT 令牌进行认证在请求头中添加以下信息?
