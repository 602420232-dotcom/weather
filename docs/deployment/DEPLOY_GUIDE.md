...
### 部署?
- [ ] 检查Docker ?Docker Compose 版本
- [ ] 检查系统资源CPU >=4核 内存 >=8G 磁盘>=50G?
- [ ] 配置 `.env` 环境变量数据库密码JWT密钥?
- [ ] 确保网络可访问Docker Hub / Maven Central
- [ ] 确保 MySQL ?Redis 端口未被占用
- [ ] 检查Java 17+ ?Maven 3.9+ 安装
- [ ] 检查Python 3.11+ ?pip 安装

### 部署?
- [ ] 基础设施启动成功MySQL/Redis/Nacos/Kafka?
- [ ] 所有微服务注册?Nacos
- [ ] API 网关路由可用
- [ ] 前端可访问
- [ ] 边云协调?WebSocket 连接正常
