...
本文档提供了无人机路径规划系统的API接口说明，包括各个微服务的接口定义、参数说明和使用示例。

## 服务列表

- **uav-platform-service**: 主服务，提供系统的核心功能
- **wrf-processor-service**: WRF气象数据处理服务
- **meteor-forecast-service**: 气象预测服务
- **path-planning-service**: 路径规划服务

## 认证与授权

所有API接口都需要使用JWT令牌进行认证。在请求头中添加以下信息：
...
- [WRF数据处理接口](wrf-processor-service/wrf.md)
