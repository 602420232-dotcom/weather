...
class FourDimensionalVarAdapter(AssimilationAdapter):
    ...
    def __init__(self) -> None:
        ...
        self.set_metadata(AlgorithmMetadata(
            ...
            version="1.0.0",
            description=(
                "4D-VAR data assimilation with temporal dimension support"
            ),
            input_schema={
                "type": "object",
                "required": ["background_field", "observations"],
...
class HybridAssimilationAdapter(AssimilationAdapter):
    ...
    def __init__(self) -> None:
        ...
        self.set_metadata(AlgorithmMetadata(
            ...
            version="1.0.0",
            description=(
                "Hybrid assimilation combining multiple algorithm strengths"
            ),
            input_schema={
                "type": "object",
                "required": ["background_field", "observations"],
    ...
    def execute(self, params: dict[str, Any]) -> dict[str, Any]:
        ...
        algo = HybridAssimilation(
            params.get("config"), params.get("algorithm_types"),
        )
        return algo.assimilate(params)
...
class EnhancedBayesianAdapter(AssimilationAdapter):
    ...
    def __init__(self) -> None:
        ...
        self.set_metadata(AlgorithmMetadata(
            ...
            version="1.0.0",
            description=(
                "Enhanced Bayesian assimilation with deep learning components"
            ),
            input_schema={
                "type": "object",
                "required": ["background_field", "observations"],
