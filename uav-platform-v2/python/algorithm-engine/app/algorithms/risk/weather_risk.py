...
class WeatherRiskAssessor:
    ...
    def assess(self) -> dict[str, Any]:
        ...
        return {"risk_score": risk_score, "risk_level": risk_level, "factors": {"wind_risk": float(wind_risk), "visibility_risk": float(vis_risk), "precipitation_risk": float(precip_risk)}}
