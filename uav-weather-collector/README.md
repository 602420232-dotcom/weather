...
无人机气象信息收集模块uav-weather-collector对接多源气象数据为路径规划提供实时气象数据支撑?
...
| `/api/weather/collect/ground` | POST | 采集地面站数?|
| `/api/weather/drone/{id}` | GET | 获取无人机实时气?|
...
| `/api/weather/sources` | GET | 获取数据源列?|
